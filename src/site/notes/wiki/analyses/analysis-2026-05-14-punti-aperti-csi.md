...
| BAT-02 | ~~**SC67**~~ ✅ **RISOLTO PER VIA TECNICA (2026-07-23).** La storicizzazione BATCH-02 è **ancorata all'informativa scaduta A**: legge `annulla_consensi` da A e àncora il record terminale a A. Allinea l'SQL §7.2 alla prosa autoritativa §6.13; nessun impatto su CDU-17 (snapshot esporta solo consensi attivi). Da segnalare a CSI come scelta di design, non domanda. **Residuo:** correggere SQL SRS §7.2. | ✅ (residuo SRS §7.2) | Prima di chiudere SRS | [[wiki/concepts/batch-processes\|Processi Batch — BATCH-01, BATCH-02, BATCH-03]] §ALG02, [[wiki/analyses/analysis-2026-05-14-risposte-mf-srs-v3\|analysis-2026-05-14-risposte-mf-srs-v3]] §Tema J |
...
> - ~~**BAT-02/SC67**~~ ✅ **risolto per via tecnica (2026-07-23):** storicizzazione ancorata all'informativa scaduta A; residuo = correggere SQL SRS §7.2.
